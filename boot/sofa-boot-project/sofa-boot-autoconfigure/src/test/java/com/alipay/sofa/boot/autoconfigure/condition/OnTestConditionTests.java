...
/**
 * Tests for {@link OnTestCondition}.
 *
 * @author huzijie
 * @version OnTestConditionTests.java, v 0.1 2023年04月04日 2:21 PM huzijie Exp $
 */
public class OnTestConditionTests {
    ...
    void checkTstEnvironment() {
        boolean isTestEnvironment = SofaBootEnvUtils.isSpringTestEnv();
        load(OnTestConfiguration.class);
        assertThat(this.context.containsBean("sample")).isEqualTo(!isTestEnvironment);
    }
    ...
    static class OnTestConfiguration {
