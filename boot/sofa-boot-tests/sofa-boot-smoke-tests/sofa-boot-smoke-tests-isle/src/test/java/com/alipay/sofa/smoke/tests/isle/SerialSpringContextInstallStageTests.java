...
/**
 * Integration tests for {@link SpringContextInstallStage} in serial.
 *
 * @author huzijie
 * @version ParallelSpringContextInstallStageTests.java, v 0.1 2023年02月21日 8:06 PM huzijie Exp $
 */
@TestPropertySource(properties = "sofa.boot.isle.moduleStartUpParallel=false")
public class SerialSpringContextInstallStageTests extends
