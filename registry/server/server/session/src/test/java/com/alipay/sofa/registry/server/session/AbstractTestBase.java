...
public class AbstractTestBase {
    ...
    public static class ConsumerProducer extends ConcurrentExecutor {

        protected final Runnable consumer;

        protected final Runnable producer;

        protected final int consumerNum;
        ...
        public static class Builder {
            protected Runnable consumer;

            protected Runnable producer;
            ...
            public Builder consumer(Runnable consumer) {
                this.consumer = consumer;
                return this;
            }

            public Builder producer(Runnable producer) {
                this.producer = producer;
                return this;
            }
            ...
            public Builder producerNum(int producerNum) {
                this.producerNum = producerNum;
                return this;
            }
