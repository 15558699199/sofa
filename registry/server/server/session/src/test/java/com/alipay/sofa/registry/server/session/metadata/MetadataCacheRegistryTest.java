...
public class MetadataCacheRegistryTest extends AbstractSessionServerTestBase {
    ...
    @InjectMocks
    private static MetadataCacheRegistry metadataCacheRegistry;
    private static List<AppRevision> appRevisionList;
    @Spy
    private InMemoryAppRevisionRepository appRevisionRepository;
    @Spy
    private InMemoryInterfaceAppsRepository interfaceAppsRepository;
    @Mock
